...
EMAIL_TEMPLATE_COLLECTION_PROVINCIAL_DUPLICATES_NOTIFICATION="<!DOCTYPE html><html xmlns:th=\"http://www.thymeleaf.org\"><head><meta charset=\"ISO-8859-1\"><title>1701ProvincialDuplicatesIdentified</title></head><body><br><br>One or more provincial duplicates have been identified for the following school: <span th:value=\"${schoolName}\"></span>. Please log into the EDX platform and open the collection to view and resolve your duplicates by <span th:value='${duplicateResolutionDueDate}'></span>: <a href=\"https://educationdataexchange.gov.bc.ca/\">https://educationdataexchange.gov.bc.ca/</a><br><br>Regards,<br>The Ministry of Education and ChildCare's EDX Team</body></html>"
