...
EMAIL_TEMPLATE_CLOSURE_REPORT_NOTIFICATION="<!DOCTYPE html><html xmlns:th=\"http://www.thymeleaf.org\"><head><meta charset=\"ISO-8859-1\"><title>1701 Closure Reports</title></head><body>Reports are now available in EDX for the [[${closeCollectionMonth}]] <span th:text=\"${closeCollectionMonth}\"></span> <span th:text=\"${closeCollectionYear}\"></span> Student Level Data Collection.<br/><br/>To view the reports, and open \"Data Collections\" in the menu. Reports can be found in each of the collections <a href=\"https://student-admin-8878b4-prod.apps.silver.devops.gov.bc.ca/login\"> log into the Student-Admin platform</a> listed.<br><br><b>The Data Management Unit Team</b><br>Ministry of Education and Child Care<br>educationdataexchange@gov.bc.ca</body></html>"
