...
echo
echo Writing scope WRITE_COLLECTION_CODES
curl -sX POST "https://$SOAM_KC/auth/admin/realms/$SOAM_KC_REALM_ID/client-scopes" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $TKN" \
  -d "{\"description\": \"Write Student Data Collection Codes\",\"id\": \"WRITE_COLLECTION_CODES\",\"name\": \"WRITE_COLLECTION_CODES\",\"protocol\": \"openid-connect\",\"attributes\" : {\"include.in.token.scope\" : \"true\",\"display.on.consent.screen\" : \"false\"}}"
...
EMAIL_TEMPLATE_COLLECTION_INDEPENDENT_SCHOOL_NOACTIVITY_NOTIFICATION="<!DOCTYPE html><html xmlns:th='http://www.thymeleaf.org'><head><meta charset='ISO-8859-1'><title>1701 File Not Yet Received for School</title></head><body>Dear Independent School Principal,<br/><br/>You are receiving this email because we have not yet received the 1701 submission from your school that was due on <span th:text=\"\${$}{submissionDueDate}\"></span>. Please submit your file as soon as possible through <a href='https://educationdataexchange.gov.bc.ca'>EDX</a>.<br/><br/>Instructions and guides for this data collection can be found at <a th:href=\"@{'https://www2.gov.bc.ca/gov/content/education-training/k-12/administration/program-management/data-collections/'+\${$}{dataCollectionMonth}}\">https://www2.gov.bc.ca/gov/content/education-training/k-12/administration/program-management/data-collections/<span th:text=\"\${$}{dataCollectionMonth}\"></span></a><br><br><br><b>The Data Management Unit Team</b><br>Ministry of Education and Child Care<br>educationdataexchange@gov.bc.ca</body></html>"

EMAIL_SUBJECT_COLLECTION_INDEPENDENT_SCHOOL_NOTSUBMITTED_NOTIFICATION="1701 Submission Not Completed for School"
EMAIL_TEMPLATE_COLLECTION_INDEPENDENT_SCHOOL_NOTSUBMITTED_NOTIFICATION="<!DOCTYPE html><html xmlns:th=\"http://www.thymeleaf.org\"><head><meta charset=\"ISO-8859-1\"><title>1701 File Not Yet Received for School</title></head><body>Dear Independent School Principal,<br/><br/>You are receiving this email because your school has yet to complete the 1701 submission that was due on <span th:text=\"\${$}{submissionDueDate}\"></span>. We can see that you have loaded a file to <a href=\"https://educationdataexchange.gov.bc.ca\">EDX</a> but have not completed your submission. Please log into EDX and complete your 1701 submission as soon possible.<br/><br/>Instructions and guides for this data collection can be found at <a th:href=\"@{'https://www2.gov.bc.ca/gov/content/education-training/k-12/administration/program-management/data-collections/'+\${$}{dataCollectionMonth}}\">https://www2.gov.bc.ca/gov/content/education-training/k-12/administration/program-management/data-collections/<span th:text=\"\${$}{dataCollectionMonth}\"></span></a><br><br><br><b>The Data Management Unit Team</b><br>Ministry of Education and Child Care<br>educationdataexchange@gov.bc.ca</body></html>"

EMAIL_SUBJECT_COLLECTION_PROVINCIAL_DUPLICATES_NOTIFICATION="1701 Provincial Duplicates Found for School"
EMAIL_TEMPLATE_COLLECTION_PROVINCIAL_DUPLICATES_NOTIFICATION="<!DOCTYPE html><html xmlns:th=\"http://www.thymeleaf.org\"><head><meta charset=\"ISO-8859-1\"><title>1701ProvincialDuplicatesIdentified</title></head><body><br><br>One or more provincial duplicates have been identified for the following school: <span th:text=\"\${$}{schoolName}\"></span>. Please log into the EDX platform and open the collection to view and resolve your duplicates by <span th:text=\"\${$}{duplicateResolutionDueDate}\"></span>: <a href=\"https://educationdataexchange.gov.bc.ca/\">https://educationdataexchange.gov.bc.ca/</a><br><br>Regards,<br>The Ministry of Education and ChildCare's EDX Team</body></html>"

EMAIL_SUBJECT_COLLECTION_DISTRICT_SIGNOFF_NOTIFICATION="Enrollment Data Final Sign-off Available"
EMAIL_TEMPLATE_COLLECTION_DISTRICT_SIGNOFF_NOTIFICATION="<!DOCTYPE html><html xmlns:th=\"http://www.thymeleaf.org\"><head><meta charset=\"ISO-8859-1\"><title>Enrollment Data Final Sign-off Available</title></head><body>Hello District Enrollment Data Administrators,<br/><br/>Final sign&#8209;off is available to your district for the current Enrollment Data (1701) collection. Please ensure that you, your district&#39;s Secretary Treasurer, and your district&#39;s Superintendent have provided sign&#8209;off by <span th:text=\"\${$}{signOffDueDate}\"></span>.<br/><br/>You can access the collection for review and sign&#8209;off through the EDX platform here: <a href=\"https://educationdataexchange.gov.bc.ca/\">https://educationdataexchange.gov.bc.ca/</a><br/><br/>Thank you,<br/>The EDX Team</body></html>"
...
SCHEDULED_JOBS_PROCESS_SCHOOL_COLLECTION_FOR_SUBMISSION_CRON="0/30 * * * * *"
...
SCHEDULED_JOBS_ADD_SCHOOLS_COLLECTION_CRON="0 0 2 * * *"
SCHEDULED_JOBS_ADD_SCHOOLS_COLLECTION_CRON_LOCK_AT_LEAST_FOR="PT4M"
SCHEDULED_JOBS_ADD_SCHOOLS_COLLECTION_CRON_LOCK_AT_MOST_FOR="PT4M"
SCHEDULED_JOBS_PROCESS_MIGRATED_SDC_STUDENTS_CRON=-
SCHEDULED_JOBS_PROCESS_MIGRATED_SDC_STUDENTS_CRON_LOCK_AT_LEAST_FOR="1700ms"
SCHEDULED_JOBS_PROCESS_MIGRATED_SDC_STUDENTS_CRON_LOCK_AT_MOST_FOR="1900ms"
SCHEDULED_JOBS_DELETE_MIGRATED_SDC_STUDENT_SAGAS_CRON=-
SCHEDULED_JOBS_DELETE_MIGRATED_SDC_STUDENT_SAGAS_CRON_LOCK_AT_LEAST_FOR="PT20S"
SCHEDULED_JOBS_DELETE_MIGRATED_SDC_STUDENT_SAGAS_CRON_LOCK_AT_MOST_FOR="PT20S"
SCHEDULED_JOBS_PURGE_OLD_SAGA_RECORDS_CRON="@midnight"
SCHEDULED_JOBS_PURGE_OLD_SAGA_RECORDS_CRON_LOCK_AT_LEAST_FOR="PT2M"
SCHEDULED_JOBS_PURGE_OLD_SAGA_RECORDS_CRON_LOCK_AT_MOST_FOR="PT2M"
...
EMAIL_TEMPLATE_CLOSURE_REPORT_NOTIFICATION="<!DOCTYPE html><html xmlns:th=\"http://www.thymeleaf.org\"><head><meta charset=\"ISO-8859-1\"><title>1701 Closure Reports</title></head><body>Reports are now available in EDX for the <span th:text=\"\${$}{closeCollectionMonth}\"></span> <span th:text=\"\${$}{closeCollectionYear}\"></span> Student Level Data Collection.<br/><br/>To view the reports, and open \"Data Collections\" in the menu. Reports can be found in each of the collections <a href=\"https://student-admin-8878b4-prod.apps.silver.devops.gov.bc.ca/login\"> log into the Student-Admin platform</a> listed.<br><br><b>The Data Management Unit Team</b><br>Ministry of Education and Child Care<br>educationdataexchange@gov.bc.ca</body></html>"
EMAIL_CLOSURE_NOTIFICATION_TO="EDUC.Compliance@gov.bc.ca,EDEDWNOT@Victoria1.gov.bc.ca,cmb@gov.bc.ca,educ.fsascore@gov.bc.ca,international.education@gov.bc.ca,EDUC.FundingandAllocationUnit@gov.bc.ca,faa.is@gov.bc.ca,EDUC.independentschoolsoffice@gov.bc.ca"
