...
EMAIL_TEMPLATE_COLLECTION_PROVINCIAL_DUPLICATES_NOTIFICATION="<!DOCTYPE html><html xmlns:th=\"http://www.thymeleaf.org\"><head><meta charset=\"ISO-8859-1\"><title>1701 Provincial Duplicates Found for School</title></head><body>One or more 1701 Provincial duplicates has been identified for the following school: <span th:text="${schoolName}"></span>.<br><br>Please log into the EDX platform and open the collection to view and resolve your duplicates by <span th:text="${duplicateResolutionDueDate}"></span>: <a href=\"https://educationdataexchange.gov.bc.ca\">https://educationdataexchange.gov.bc.ca</a><br><br></body></html>"
...
SCHEDULED_JOBS_PROCESS_UPDATE_STUDENT_DOWNSTREAM_CRON="0/2 * * * * *"
SCHEDULED_JOBS_PROCESS_UPDATE_STUDENT_DOWNSTREAM_CRON_LOCK_AT_LEAST_FOR="1700ms"
SCHEDULED_JOBS_PROCESS_UPDATE_STUDENT_DOWNSTREAM_CRON_LOCK_AT_MOST_FOR="1900ms"
