...
EMAIL_TEMPLATE_COLLECTION_INDEPENDENT_SCHOOL_NOACTIVITY_NOTIFICATION="<!DOCTYPE html><html xmlns:th="http://www.thymeleaf.org"><head><meta charset="ISO-8859-1"><title>1701 File Not Yet Received for School</title></head><body>Dear Independent School Principal,<br/><br/>You are receiving this email because we have not yet received the 1701 submission from your school that was due on <span th:text="${submissionDueDate}"></span>. Please submit your file as soon as possible through <a href="https://educationdataexchange.gov.bc.ca">EDX</a>.<br/><br/>Instructions and guides for this data collection can be found at <a href="@{'https://www2.gov.bc.ca/gov/content/education-training/k-12/administration/program-management/data-collections/' +${dataCollectionMonth}}">https://www2.gov.bc.ca/gov/content/education-training/k-12/administration/program-management/data-collections/<span th:text="${dataCollectionMonth}"></span></a><br><br><br><b>The Data Management Unit Team</b><br>Ministry of Education and Child Care<br>educationdataexchange@gov.bc.ca</body></html>"

EMAIL_SUBJECT_COLLECTION_INDEPENDENT_SCHOOL_NOTSUBMITTED_NOTIFICATION="1701 Submission Not Completed for School"
EMAIL_TEMPLATE_COLLECTION_INDEPENDENT_SCHOOL_NOTSUBMITTED_NOTIFICATION="<!DOCTYPE html><html xmlns:th="http://www.thymeleaf.org"><head><meta charset="ISO-8859-1"><title>1701 File Not Yet Received for School</title></head><body>Dear Independent School Principal,<br/><br/>You are receiving this email because your school has yet to complete the 1701 submission that was due on <span th:text="${submissionDueDate}"></span>. We can see that you have loaded a file to <a href="https://educationdataexchange.gov.bc.ca">EDX</a> but have not completed your submission. Please log into EDX and complete your 1701 submission as soon possible.<br/><br/>Instructions and guides for this data collection can be found at <a href="@{'https://www2.gov.bc.ca/gov/content/education-training/k-12/administration/program-management/data-collections/' +${dataCollectionMonth}}">https://www2.gov.bc.ca/gov/content/education-training/k-12/administration/program-management/data-collections/<span th:text="${dataCollectionMonth}"></span></a><br><br><br><b>The Data Management Unit Team</b><br>Ministry of Education and Child Care<br>educationdataexchange@gov.bc.ca</body></html>"
