...
SCHEDULED_JOBS_PROCESS_MIGRATED_SDC_STUDENTS_CRON="0/2 * * * * *"
...
SCHEDULED_JOBS_PROCESS_MIGRATED_SDC_STUDENTS_CRON="0/20 * * * * *"
SCHEDULED_JOBS_PROCESS_MIGRATED_SDC_STUDENTS_CRON_LOCK_AT_LEAST_FOR="PT20S"
SCHEDULED_JOBS_PROCESS_MIGRATED_SDC_STUDENTS_CRON_LOCK_AT_MOST_FOR="PT20S"
