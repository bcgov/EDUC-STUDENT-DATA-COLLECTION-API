...
SCHEDULED_JOBS_PROCESS_LOADED_SDC_STUDENTS_CRON="0/1 * * * * *"
...
SCHEDULED_JOBS_PROCESS_LOADED_SDC_STUDENTS_CRON_LOCK_AT_LEAST_FOR="PT2M"
SCHEDULED_JOBS_PROCESS_LOADED_SDC_STUDENTS_CRON_LOCK_AT_MOST_FOR="PT2M"
