...
public interface SdcSchoolCollectionStudentRepository extends JpaRepository<SdcSchoolCollectionStudentEntity, UUID>, JpaSpecificationExecutor<SdcSchoolCollectionStudentEntity> {
  ...
  @Query("SELECT " +
          ...
          "COUNT(CASE WHEN s.sdcSchoolCollectionStudentStatusCode != 'ERROR' AND s.careerProgramNonEligReasonCode IS NULL AND ep.enrolledProgramCode = '42' THEN 1 END) AS techYouthTotal, " +
