...
import ca.bc.gov.educ.studentdatacollection.api.model.v1.SagaEvent;
...
public interface SagaMapper {
   ...
   */
  ca.bc.gov.educ.studentdatacollection.api.struct.v1.Saga toStruct(Saga entity);
   ...
   * @return the saga
   */
  Saga toModel(ca.bc.gov.educ.studentdatacollection.api.struct.v1.Saga struct);

  @Mapping(target = "sagaId", source = "saga.sagaId")
  ca.bc.gov.educ.studentdatacollection.api.struct.v1.SagaEvent toEventStruct(SagaEvent sagaEvent);
}
