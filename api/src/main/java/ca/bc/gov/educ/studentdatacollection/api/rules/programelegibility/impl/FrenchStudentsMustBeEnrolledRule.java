...
public class FrenchStudentsMustBeEnrolledRule implements ProgramEligibilityBaseRule {
  ...
  public boolean shouldExecute(StudentRuleData studentRuleData, List<ProgramEligibilityIssueCode> errors) {
    log.debug("In shouldExecute of ProgramEligibilityBaseRule - FrenchStudentsMustBeEnrolledRule: for collectionType {} and sdcSchoolCollectionStudentID :: {}" , FteCalculatorUtils.getCollectionTypeCode(studentRuleData),
