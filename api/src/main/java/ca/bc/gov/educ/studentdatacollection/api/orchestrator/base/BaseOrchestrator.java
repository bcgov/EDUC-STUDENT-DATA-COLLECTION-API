...
import static ca.bc.gov.educ.studentdatacollection.api.constants.EventOutcome.SAGA_COMPLETED;
import static ca.bc.gov.educ.studentdatacollection.api.constants.EventType.INITIATED;
import static ca.bc.gov.educ.studentdatacollection.api.constants.EventType.MARK_SAGA_COMPLETE;
...
public abstract class BaseOrchestrator<T> implements EventHandler, Orchestrator {
  ...
  @Override
  @Transactional
  public SdcSagaEntity createSaga(@NotNull final String payload, final UUID sdcSchoolStudentID, final UUID sdcSchoolCollectionID, final String userName) {
    return this.sagaService.createSagaRecordInDB(this.sagaName, userName, payload, sdcSchoolStudentID, sdcSchoolCollectionID);
  }
