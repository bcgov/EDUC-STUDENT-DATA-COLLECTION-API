...
@Slf4j
@Order(300)
public class SchoolAgedOnlineZeroCourseHistoryRule extends BasePENRule implements ValidationBaseRule {
    ...
    public List<SdcSchoolCollectionStudentValidationIssue> executeValidation(StudentRuleData studentRuleData) {
        ...
        boolean isContEd = Objects.equals(schoolType, String.valueOf(CONT_ED));

        if((!isAdult && isOnline) || (!isAdult && isContEd)){
