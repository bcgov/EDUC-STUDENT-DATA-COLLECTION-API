...
public enum DuplicateErrorDescriptionCode {
  ...
  NON_ALT_DUP("NON_ALT_DUP", "The student is enrolled in two different districts or authorities not involving an Online Learning school, only one school may claim the student"),
