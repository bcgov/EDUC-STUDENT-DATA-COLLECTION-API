...
public enum ValidationRulesDependencyMatrix {
    ...
    ENTRY52("V34", new String[]{NO_OF_COURSES_INVALID.getCode(), INVALID_GRADE_CODE.getCode(), DOB_INVALID_FORMAT.getCode(), GENDER_INVALID.getCode(), LEGAL_LAST_NAME_BLANK.getCode(), LEGAL_FIRST_NAME_CHAR_FIX.getCode(), LEGAL_MIDDLE_NAME_CHAR_FIX.getCode(), LEGAL_LAST_NAME_CHAR_FIX.getCode(), USUAL_FIRST_NAME_CHAR_FIX.getCode(), USUAL_MIDDLE_NAME_CHAR_FIX.getCode(), USUAL_LAST_NAME_CHAR_FIX.getCode()}),
    ENTRY53("V47", new String[]{NO_OF_COURSES_INVALID.getCode(), INVALID_GRADE_CODE.getCode(), DOB_INVALID_FORMAT.getCode(), GENDER_INVALID.getCode(), LEGAL_LAST_NAME_BLANK.getCode(), LEGAL_FIRST_NAME_CHAR_FIX.getCode(), LEGAL_MIDDLE_NAME_CHAR_FIX.getCode(), LEGAL_LAST_NAME_CHAR_FIX.getCode(), USUAL_FIRST_NAME_CHAR_FIX.getCode(), USUAL_MIDDLE_NAME_CHAR_FIX.getCode(), USUAL_LAST_NAME_CHAR_FIX.getCode()}),
    ...
    ENTRY58("V90", new String[]{FUNDING_CODE_INVALID.getCode(), ENROLLED_CODE_PARSE_ERR.getCode(), ENROLLED_CODE_INVALID.getCode()});
