...
public enum ValidationRulesDependencyMatrix {
    ...
    ENTRY21("V49", new String[]{RulesConstants.DOB_INVALID_FORMAT}),
    ENTRY22("V45", new String[]{RulesConstants.DOB_INVALID_FORMAT, RulesConstants.INVALID_GRADE_CODE}),
    ENTRY23("V48", new String[]{RulesConstants.DOB_INVALID_FORMAT, RulesConstants.INVALID_GRADE_CODE}),
    ...
    ENTRY35("V69", new String[]{RulesConstants.DOB_INVALID_FORMAT, RulesConstants.SUPPORT_BLOCKS_INVALID, RulesConstants.INVALID_GRADE_CODE}),
