 ...
 */
@Configuration
public class StudentDataCollectionAPIMVCConfig implements WebMvcConfigurer {
   ...
   */
  @Autowired
  public StudentDataCollectionAPIMVCConfig(final RequestResponseInterceptor requestResponseInterceptor) {
