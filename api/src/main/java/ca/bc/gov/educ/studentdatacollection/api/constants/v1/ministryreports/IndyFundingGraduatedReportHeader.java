...
@Getter
public enum IndyFundingGraduatedReportHeader {
    ...
    IndyFundingGraduatedReportHeader(String code) { this.code = code; }

    public static String[] getAllValuesAsStringArray(){
        return Arrays.stream(IndyFundingGraduatedReportHeader.values()).map(IndyFundingGraduatedReportHeader::getCode).toArray(String[]::new);
    }
}
