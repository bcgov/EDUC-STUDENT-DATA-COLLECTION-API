...
@Component
@Slf4j
public class IndySchoolNotSubmittedEmailOrchestrator extends BaseOrchestrator<EmailSagaData> {

  private final EmailService emailService;
  protected IndySchoolNotSubmittedEmailOrchestrator(final SagaService sagaService, final MessagePublisher messagePublisher, EmailService emailService) {
    super(sagaService, messagePublisher, EmailSagaData.class, SagaEnum.INDY_SCHOOLS_NOT_SUBMITTED_EMAIL_SAGA.toString(), TopicsEnum.INDY_SCHOOLS_NOT_SUBMITTED_EMAIL_SAGA_TOPIC.toString());
  ...
  private void completeSendEmail(final Event event, final SdcSagaEntity saga, final EmailSagaData sdcStudentSagaData) {
    //This is ok
  }
