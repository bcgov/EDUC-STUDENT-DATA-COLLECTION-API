...
/**
 * The Student Data Collection api application.
 *
 * @author OM
 */
...
@EnableRetry
public class StudentDataCollectionApiApplication {
  ...
  public static void main(final String[] args) {
    SpringApplication.run(StudentDataCollectionApiApplication.class, args);
  }
