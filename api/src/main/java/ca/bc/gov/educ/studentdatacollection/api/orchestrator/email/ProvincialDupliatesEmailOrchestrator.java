...
@Component
@Slf4j
public class ProvincialDupliatesEmailOrchestrator extends BaseOrchestrator<EmailSagaData> {
    private final EmailService emailService;

    protected ProvincialDupliatesEmailOrchestrator(final SagaService sagaService, final MessagePublisher messagePublisher, EmailService emailService) {
        super(sagaService, messagePublisher, EmailSagaData.class, SagaEnum.PROVINCE_DUPLICATE_PROCESSING_SAGA.toString(), TopicsEnum.PROVINCE_DUPLICATE_PROCESS_TOPIC.toString());
