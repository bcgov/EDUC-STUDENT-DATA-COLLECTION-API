...
public enum StudentValidationIssueTypeCode {
  ...
  ADULT_ZERO_COURSE_HISTORY("ADULTZEROCOURSEH", "Zero courses reported for an adult student and no course activity for the past two years."),
  SCHOOL_AGED_ZERO_COURSE_HISTORY("SCHOOLAGEDZEROCOURSEH", "Student has zero courses reported and no course activity for the past two years. This student will not receive program funding."),
  ...
  REFUGEE_NOT_IN_SEPT_COL("REFUGEENINSEPTCOL", "Refugee not reported in September Collection will not receive funding."),
  ;
