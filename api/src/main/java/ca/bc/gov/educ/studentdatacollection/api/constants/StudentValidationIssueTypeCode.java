...
public enum StudentValidationIssueTypeCode {
  ...
  PROGRAM_CODE_HS_SPED("PROGRAMCODEHSSPED", "Home school students will not be funded for any reported special education designations.", FUNDING_WARNING),
  ...
  ENROLLED_CODE_SP_ED_ERR("ENROLLEDCODESPEDERR", "Out-of-Province/International students will not be funded any reported special education programs.", FUNDING_WARNING),
  ...
  SPED_ERR("SPEDERR", "Reported Special Education Category is not valid.", ERROR),
