...
public enum StudentValidationIssueTypeCode {
  ...
  SCHOOLAGE_ZERO_COURSES("SCHOOLAGEZEROCOURSES", "Secondary students must be reported with at least one course. If the student is not enrolled in any courses they should be removed from the submission.", FUNDING_WARNING),
  ...
  CAREER_CODE_PROG_ERR("CAREERCODEPROGERR", "Student must be reported with both an Enrolled Career Program and Career Code.", ERROR),
  ...
  SUMMER_ENROLLED_PROGRAM_ERROR("SUMMERENROLLEDPROGRAMERROR","Students enrolled in the grade 8/9 cross-enrolment collection are not eligible for funding for inclusive education or additional programs.", FUNDING_WARNING),
