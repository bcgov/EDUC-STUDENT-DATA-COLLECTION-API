...
public enum StudentValidationIssueTypeCode {
  ...
  ADULT_ZERO_COURSES("ADULTZEROCOURSES", "Adult students must have more than 0 courses.", FUNDING_WARNING),
  SCHOOLAGE_ZERO_COURSES("SCHOOLAGEZEROCOURSES", "Secondary students must be reported with at least one course. If the student is not enroled in any courses they should be removed from the submission.", FUNDING_WARNING),
