...
public enum StudentValidationIssueTypeCode {
  ...
  ENROLLED_NO_FRANCOPHONE("ENROLLEDNOFRANCOPHONE", "Students in a Conseil francophone school must be enroled in Programme francophone.", ERROR),
  ENROLLED_CODE_INVALID("ENROLLEDCODEINVALID", "List of enroled programs includes an invalid code. Select the valid programs for the student.", ERROR),
  ...
  SCHOOLAGE_ZERO_COURSES("SCHOOLAGEZEROCOURSES", "Secondary students must be reported with at least one course. If the student is not enroled in any courses they should be removed from the submission.", ERROR),
  ...
  SUMMER_GRADE_CODE("SUMMERGRADECODE", "Students in summer school must enroled in grade 1-12.", ERROR),
  ...
  ENROLLED_CODE_PARSE_ERR("ENROLLEDCODEPARSEERR", "List of enroled program codes could not be parsed. Select the correct program codes for the student.", ERROR),
  ENROLLED_CODE_DUP_ERR("ENROLLEDCODEDUPERR", "List of enroled codes contained duplicate codes. Duplicate codes have been removed. Verify that the codes below are the correct codes for the student.", ERROR),
  ...
  SUMMER_STUDENT_REPORTED_NOT_IN_DISTRICT_ERROR("SUMMERSTUDENTREPORTEDNOTINDISTRICTERROR","Student was not reported in Grade 8 or 9 this school year and cannot be reported in 8/9 cross enrollment in this collection.", FUNDING_WARNING),
