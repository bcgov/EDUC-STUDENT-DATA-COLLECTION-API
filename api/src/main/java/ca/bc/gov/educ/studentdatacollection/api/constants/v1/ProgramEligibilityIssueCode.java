...
public enum ProgramEligibilityIssueCode {
  ...
  NON_ELIG_SPECIAL_EDUCATION("NELISPED", "Student must be school-aged, not a non-graduated adult reported in grade GA and have been reported in ELL for 5 years or less."),
