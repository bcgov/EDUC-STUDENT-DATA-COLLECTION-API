...
SELECT
    ...
    CASE
        ...
        WHEN EXTRACT(MONTH FROM TO_DATE(sld_student.REPORT_DATE,'YYYYMMDD')) >= 9 AND months_between(TO_DATE(EXTRACT(YEAR FROM TO_DATE(sld_student.REPORT_DATE,'YYYYMMDD')) || '0630','YYYYMMDD'), TO_DATE(sld_student.BIRTH_DATE,'YYYYMMDD'))/12 >= 5
