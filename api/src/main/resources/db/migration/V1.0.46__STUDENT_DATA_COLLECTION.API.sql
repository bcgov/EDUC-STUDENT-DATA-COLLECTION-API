...
(
    ...
    SDC_SCHOOL_COLLECTION_STUDENT_ID_1         UUID                                NOT NULL,
    SDC_SCHOOL_COLLECTION_STUDENT_ID_2         UUID                                NOT NULL,
...
ALTER TABLE SDC_DUPLICATE
    ADD CONSTRAINT FK_SDC_SCHOOL_COLLECTION_STUDENT_ID_1 FOREIGN KEY (SDC_SCHOOL_COLLECTION_STUDENT_ID_1)
        REFERENCES SDC_SCHOOL_COLLECTION_STUDENT (SDC_SCHOOL_COLLECTION_STUDENT_ID);

ALTER TABLE SDC_DUPLICATE
    ADD CONSTRAINT FK_SDC_SCHOOL_COLLECTION_STUDENT_ID_2 FOREIGN KEY (SDC_SCHOOL_COLLECTION_STUDENT_ID_2)
        REFERENCES SDC_SCHOOL_COLLECTION_STUDENT (SDC_SCHOOL_COLLECTION_STUDENT_ID);
...
CREATE INDEX SDC_SCHOOL_COLLECTION_STUDENT_ID_1_IDX ON SDC_DUPLICATE (SDC_SCHOOL_COLLECTION_STUDENT_ID_1);
CREATE INDEX SDC_SCHOOL_COLLECTION_STUDENT_ID_2_IDX ON SDC_DUPLICATE (SDC_SCHOOL_COLLECTION_STUDENT_ID_2);
