...
ALTER TABLE COLLECTION
ADD COLUMN SUBMISSION_DUE_DATE DATE;

ALTER TABLE COLLECTION
ADD COLUMN DUPLICATION_RESOLUTION_DUE_DATE DATE;

ALTER TABLE COLLECTION
ADD COLUMN SIGN_OFF_DUE_DATE DATE;
...
ALTER TABLE COLLECTION
ALTER COLUMN SUBMISSION_DUE_DATE SET NOT NULL;

ALTER TABLE COLLECTION
ALTER COLUMN DUPLICATION_RESOLUTION_DUE_DATE SET NOT NULL;

ALTER TABLE COLLECTION
ALTER COLUMN SIGN_OFF_DUE_DATE SET NOT NULL;
